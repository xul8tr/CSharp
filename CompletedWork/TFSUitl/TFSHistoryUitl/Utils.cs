...
namespace TFSHistoryUitl
{
    internal class Utils
    {
        ...
        internal static WorkItemStore GetWorkItemStore(string tfsUrl)
        {
        ...
        /// <returns></returns>
        internal static QueryDefinition FindQueryItem(string tfsUrl, string projectName, string queryName)
        {
        ...
        internal static QueryDefinition FindQueryItem(WorkItemStore workItemStore, string projectName, string queryName)
        {            
            Project project = workItemStore.Projects[projectName];
            return FindQueryItem(queryName, project.QueryHierarchy);
        }
        ...
        /// <returns></returns>
        internal static WorkItemCollection GetWorkItemCollectionWithStoredQuery(WorkItemStore workItemStore, string projectName, string queryName)
        {
        ...
        internal static WorkItemCollection QueryWorkItems(WorkItemStore workItemStore, string wiqlQuery)
        {
        ...
        internal static void WriteToTFS(String tfsServer, String workItemType, String project, Hashtable values)
        {
