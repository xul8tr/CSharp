            ...
            switch (args.Length)
            {
                case 0:
                    ...
                    foreach (string s in stringlist)
                    {
                        ...
                        for (int j = beginchar; j < stringlength - 1; j = j + step)
                        {
                        ...
                        Console.WriteLine(s.ElementAt(stringlength - 1));
                    }
                    i = new ConsoleKeyInfo();
                    while (i.Key != ConsoleKey.Enter)
                    {
            ...
            if (questiontext != null)
            {
                ...
                switch (i.Key)
                {
                    case ConsoleKey.Y:
                        ...
                        {
                            stringlength = s.Length;
                            for (int j = stringlength - 1; j >= beginchar; j = j - step)
                            {
                            ...
                            Console.WriteLine(s.ElementAt(firstchar - 1));
                        }
                        i = new ConsoleKeyInfo();
                        while (i.Key != ConsoleKey.Enter)
                        {
