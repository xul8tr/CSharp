        ...
        start:
            ...
            switch (args.Length)
            {
                case 0:
                    ...
                    holderstring = stringBuilder.ToString(0, stringBuilder.Length - 1);
                    ...
                    foreach (string s in stringlist)
                    {
                        ...
                        for (int j = beginchar; j < stringlength; j = j + step)
                        {
                            if (!(j.ToString().Equals((stringlength).ToString("d"))))
                            {
                                Console.Write(charlist.ElementAt(j));
                            }
                            Thread.Sleep(500);
                        }
                        Console.WriteLine(charlist.ElementAt(charlist.Count-1));
                    }
                    i = new ConsoleKeyInfo();
                    while (i.Key != ConsoleKey.Enter)
                    {
            ...
            if (questiontext != null)
            {
                ...
                Console.Clear();
                foreach (string s in newstringlist)
                {
                    stringlength = s.Length;
                    for (int j = beginchar; j < stringlength; j = j + step)
                    {
                        if (!(j.ToString().Equals((stringlength - 1).ToString("d"))))
                        {
                            Console.Write(newcharlist.ElementAt(j));
                        }
                        Thread.Sleep(100);
                    }
                    Console.WriteLine(newcharlist.ElementAt(newcharlist.Count-1));
                }
                i = new ConsoleKeyInfo();
                ...
                switch (i.Key)
                {
                    case ConsoleKey.Y:
                        ...
                        {
                            stringlength = s.Length;
                            for (int j = stringlength; j >= beginchar; j = j - step)
                            {
                                if (!(j.ToString().Equals((beginchar).ToString("d"))))
                                {
                                    Console.Write(charlist.ElementAt(j));
                                }
                            }
                            Console.WriteLine(charlist.ElementAt(beginchar));
                        }
                        i = new ConsoleKeyInfo();
                        while (i.Key != ConsoleKey.Enter)
                        {
